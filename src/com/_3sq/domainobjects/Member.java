...
public class Member {
	 ...
	 * @param MemberName
	 */
	public void setMemberName(String m_MemberName) {
		this.m_MemberName = m_MemberName;
	}
	 ...
	 */
	public void setMemberAddress(String m_MemberAddress) {
		this.m_MemberAddress = m_MemberAddress;
	}
	 ...
	 * @param ContactNumber
	 */
	public void setContactNumber(long m_ContactNumber) {
	 ...
	 * @param Occupation
	 */
	public void setOccupation(String m_Occupation) {
